...
class FollowingViewModel:ViewModel() {
    ...
    private val _followingData = MutableLiveData<ArrayList<ListUserResponse>>()
    ...
    fun getListFollowing(): LiveData<ArrayList<ListUserResponse>>{
        return _followingData
    }
}